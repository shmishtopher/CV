...
\begin{document}
  ...
  \begin{cvsection}{Research}
    ...
    Lead investigator studying and developing unsupervised text classification techniques for analyzing dark web documents.  CCSCNE 2022 Finalist (to be presented in April 2022).\\
